...
The enclosed Python code can be used to reproduce the case studies utilized in "Combining MORL with Restraining Bolts to Learn Normative Behaviour". Parts of the code (most of convexhull.py, and parts pf CHVI.py and weight_computation.py) was adapted from code provided to us by one of the authors of "Multi-objective reinforcement learning for guaranteeing alignment with multiple values", M. Rodriguez-Soto.
